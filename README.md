...
Choosing **Yes** first shows a concise start summary listing the first gym, saved difficulty preset, and enabled rules. It then safely updates the already received native starter, fully heals the party, and routes the player to the first physical gym. It does not replace either game’s native starter or early-story scripts.
